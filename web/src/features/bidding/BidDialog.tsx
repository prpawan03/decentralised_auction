      ...
      footer={
        <>
          ...
          <Button
            ...
            loadingLabel={
              isSigning ? "Waiting for your wallet" : "Checking the bid against the contract"
            }
          >
    ...
    >
      <div className="flex flex-col gap-4">
        ...
        {blockedReason ? (
          <p
            role="alert"
            className="border-l-2 border-[var(--color-danger)] py-1 pl-3 text-[0.8125rem] text-[var(--color-danger)]"
          >
            {blockedReason}
          </p>
        ) : null}
        ...
        <Field
          ...
          hint={
            <>
              At least{" "}
              <strong className="tnum text-[var(--color-ink-2)]">{formatEth(floor)} ETH</strong>.
        ...
        <div className="border-t border-[var(--color-line)] pt-4">
          ...
          {feeEstimate === null && simulation.isSuccess ? (
            <p className="mt-2 text-[0.6875rem] text-[var(--color-ink-3)]">
              The gas estimate is not available yet. Your wallet will show the final cost before you
              sign.
            </p>
          ) : null}
        </div>
