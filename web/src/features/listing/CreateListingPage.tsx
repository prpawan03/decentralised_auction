      ...
      <form onSubmit={(e) => void onSubmit(e)} noValidate className="mt-6 flex flex-col gap-6">
            ...
            {LISTING_FORMATS.map((f) => (
              <label key={f.id} className="flex items-start gap-2.5 text-[0.8125rem]">
                ...
                <span>
                  ...
                  <span className="block text-[0.75rem] text-[var(--color-ink-3)]">
                    {f.describe}
                  </span>
                </span>
              </label>
        ...
        >
          ...
          {createError && !createError.rejected ? (
            <p
              role="alert"
              className="mt-2 max-w-prose text-[0.8125rem] leading-relaxed text-[var(--color-danger)]"
            >
              {createError.message}
            </p>
          ) : null}
          {submitError ? (
            <p
              role="alert"
              className="mt-2 max-w-prose text-[0.8125rem] text-[var(--color-danger)]"
            >
              {submitError}
            </p>
          ) : null}
