...
import { ENDING_SOON_SECONDS, isDutch, phaseOf, type Auction } from "@/lib/auction";
...
export function AntiSnipeBadge({
  auction,
  compact = false,
}: {
  auction: Auction;
    ...
    return (
      ...
      >
        ...
        <span className="sr-only">
          Anti-snipe extension fired. The auction was extended by {ENDING_SOON_SECONDS / 60}{" "}
          minutes. This is extension number {count}.
        </span>
      </Pill>
    );
  }
