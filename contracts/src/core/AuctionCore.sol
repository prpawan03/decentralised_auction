...
abstract contract AuctionCore is ERC721Holder, ReentrancyGuard, Pausable, Ownable2Step {
    ...
    function _openAuction(
        ...
        // `from` is the caller, who must own or be approved for the token, so
        // this is the lister escrowing their own item. Not an arbitrary sender.
        // nosemgrep: arbitrary-send-erc20
